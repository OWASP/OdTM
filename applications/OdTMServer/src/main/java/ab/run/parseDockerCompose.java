        ...
        if (conf.init(args[0])) {
          ...
          for (int i = 0; i < appFiles.length; i++) {
             ...
             if (diagram != null){
                ...
                DiagramSaverAsOntology saverOnt = new DiagramSaverAsOntology();
                if (!saverOnt.init(baseModelFile)){
                   LOGGER.severe("could not found the base model "+baseModelFile);
                   System.exit(1);
                }
